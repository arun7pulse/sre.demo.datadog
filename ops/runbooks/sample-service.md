...
"@ | Set-Content -Path docs\demo-runbook.md
...
## Immediate checks
- Confirm recent deploys and config changes
- Inspect logs for errors in /error path
- Verify Datadog agent connectivity

## Rollback
- Revert service version or disable traffic generator
